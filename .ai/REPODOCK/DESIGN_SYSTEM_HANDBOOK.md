# IVR Suite — Design System & Agent Handbook

A reference for understanding the visual language, identifying every component, and extending the interface without breaking its character.
