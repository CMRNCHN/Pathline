...
const api = {
  ...
  // Evidence Bundles
  listEvidenceBundles: () => _fetch('/api/evidence-bundles'),
  exportEvidenceBundle: (payload) => _post('/api/evidence-bundles/export', payload),
  getBundleManifest: (id) => _fetch('/api/evidence-bundles/' + id + '/manifest'),
  getBundleReport: (id) => _fetch('/api/evidence-bundles/' + id + '/report'),
};
