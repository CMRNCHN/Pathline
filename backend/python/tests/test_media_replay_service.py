...
from ivr_assessor.replay.media_replay_service import MediaReplayService
from ivr_assessor.events.waveform_metadata import WaveformService
from ivr_assessor.backend.ui.ui_state import RECORDINGS_DIR
...
def test_resolve_recording_path(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("ivr_assessor.replay.media_replay_service.RECORDINGS_DIR", rec_dir)
