...
from ivr_assessor.testing.evidence_exporter import EvidenceExporter
from ivr_assessor.backend.ui.ui_state import EVIDENCE_BUNDLES_DIR, EVENTS_DIR
...
def test_evidence_exporter_basic(tmp_path):
    ...
    import ivr_assessor.testing.evidence_exporter as ee
