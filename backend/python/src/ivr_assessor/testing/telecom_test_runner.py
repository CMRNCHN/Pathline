...
from .telecom_test_plan import TelecomTestPlan
from .telecom_test_result import TelecomTestResult, TestOutcome
...
class TelecomTestRunner:
    ...
    def _stop_test(self, outcome: TestOutcome, reason: str):
        ...
        # Stop the session
        from ..backend.routes.mapper_routes import handle_end
        handle_end()
