...
_DATA = Path.home() / ".ivr_assessor"

# Test suite storage (legacy editor + run suites)
SUITES_DIR         = _DATA / "suites"
RUN_SUITES_DIR     = _DATA / "run_suites"

# Runtime output directories — canonical paths for all storage consumers
REPORTS_DIR        = _DATA / "reports"
RUN_SUITE_REPORTS_DIR = _DATA / "run_suite_reports"
