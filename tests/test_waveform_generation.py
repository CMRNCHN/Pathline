...
def test_waveform_generation(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("replay.media_sync.waveform_metadata.RECORDINGS_DIR", rec_dir)
    monkeypatch.setattr("replay.media_sync.waveform_metadata.WAVEFORMS_DIR", wf_dir)
