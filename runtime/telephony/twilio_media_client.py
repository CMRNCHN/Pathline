"""runtime/telephony/twilio_media_client.py — Twilio Media Streams handling.
...
This is distinct from runtime/telephony/twilio_client.py, which holds the
TelephonyClient-protocol call-control client (TwilioTelephonyClient).
"""
...
def client_from_env(stream_host: str) -> TwilioMediaClient:
    """Construct a TwilioMediaClient from environment variables.
